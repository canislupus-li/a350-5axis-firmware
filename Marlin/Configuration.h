 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 400, 400, 400, 888.89, 888.89, 212.21}
#define SINGLE_EXTRUDER_E_STEPS_PER_MM  212.21
#define DUAL_EXTRUDER_E_STEPS_PER_MM    667.222
#define DEFAULT_TMC_AXIS_STEPS_PER_UNIT   { MODULE_LINEAR_PITCH_20, MODULE_LINEAR_PITCH_20, MODULE_LINEAR_PITCH_8, 888.89, 888.89, 212.21 }
 ...
 *                                      X, Y, Z, B, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE            { 120, 120, 40, 45, 45, 40 }
#define DEFAULT_3DP_MAX_FEEDRATE        { 120, 120, 40, 45, 45, 40 }
#define DEFAULT_3DP_FT_MAX_FEEDRATE_L8  { 120, 120, 40, 45, 45, 40 }
#define DEFAULT_3DP_FT_MAX_FEEDRATE_L20 { 120, 120, 40, 45, 45, 40 }
#define DEFAULT_LASER_MAX_FEEDRATE      { 120, 120, 40, 45, 45, 40 }
#define DEFAULT_CNC_MAX_FEEDRATE        { 120, 120, 40, 45, 45, 40 }
...
#define DEFAULT_3DP_MAX_ACCELERATION        { 3000, 3000, 100, 3000, 3000, 10000 }
#define DEFAULT_3DP_FT_MAX_ACCELERATION_L8  { 3500, 3500, 100, 3000, 3000, 10000 }
#define DEFAULT_3DP_FT_MAX_ACCELERATION_L20 { 4500, 4500, 100, 3000, 3000, 10000 }
