...
#define INVERT_J_STEP_PIN false  // A350 + 5-axis: A-axis uses 'J' character
...
#define FT_MOTION
  ...
  #define FTM_LINEAR_ADV_DEFAULT_K      0.0008f      // Default linear advance gain
  ...
  #define FTM_SYNC_POSITION_SIZE      10
