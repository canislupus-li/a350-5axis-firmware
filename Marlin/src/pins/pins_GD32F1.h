...
//                                                                                          ^ A-axis via J (5-axis, V10: A=P2, B=P6, matching original design)
...
extern int8_t a_step_pin, a_dir_pin, a_enable_pin;
extern int8_t b_step_pin, b_dir_pin, b_enable_pin;
extern int8_t j_step_pin, j_dir_pin, j_enable_pin;  // A350 + 5-axis: A-axis uses 'J' character
...
#define A_STEP_PIN         a_step_pin    // P2 - Add-on (Rotary A)
#define A_DIR_PIN          a_dir_pin
#define A_ENABLE_PIN       a_enable_pin

#define B_STEP_PIN         b_step_pin    // P6 - Add-on 2
#define B_DIR_PIN          b_dir_pin
#define B_ENABLE_PIN       b_enable_pin

#define J_STEP_PIN         j_step_pin    // P2 - A-axis (5-axis upgrade), uses 'J' to avoid conflict with B
#define J_DIR_PIN          j_dir_pin
#define J_ENABLE_PIN       j_enable_pin
